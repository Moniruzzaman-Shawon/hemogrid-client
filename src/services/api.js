...
const api = {
  ...
  bloodRequests: {
    list: () => apiClient.get("/blood-requests/"),
    create: (data) => apiClient.post("/blood-requests/create/", data),
    accept: (id) => apiClient.post(`/blood-requests/${id}/accept/`),
    complete: (id) => apiClient.post(`/blood-requests/${id}/complete/`),
    cancel: (id) => apiClient.post(`/blood-requests/${id}/cancel/`),
    updateStatus: (id, data) => apiClient.put(`/blood-requests/${id}/update-status/`, data),
    ...
    getContact: (id) => apiClient.get(`/blood-requests/${id}/contact/`),
    adminRequests: () => apiClient.get("/blood-requests/admin/requests/"),
    adminStats: () => apiClient.get("/blood-requests/admin/stats/"),
  },
  notifications: {
