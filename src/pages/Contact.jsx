      ...
      <div className="relative z-10 w-full max-w-6xl grid gap-10 md:grid-cols-2 bg-white/20  rounded-2xl p-6 sm:p-10 shadow-xl">
        ...
        <div className="flex flex-col justify-center text-black text-center md:text-left">
          ...
          <p className="text-sm sm:text-base mb-6">
            Have questions or want to help? Reach out to us — we’re here to listen and respond as quickly as possible.
          </p>
        ...
        <form className="flex flex-col gap-4 text-gray-900">
          <input
            ...
            className="p-3 rounded-lg bg-white/90 backdrop-blur-sm border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500 transition"
          />
          <input
            type="email"
          ...
          <textarea
            rows="5"
            placeholder="Message"
            className="p-3 rounded-lg bg-white/90 backdrop-blur-sm border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500 resize-none transition"
          ></textarea>
          <button
            type="submit"
